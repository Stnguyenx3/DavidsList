...
define('DB_NAME', 'student_nschinke');  #Change to student_USERNAME
define('DB_USER', 'nschinke'); 			#Used for testing, change to your mysql credentials
define('DB_PASS', 'tuinkers');
