<div class="container main privacy" id="image-container">
    ...
    <p>
		...
		This privacy policy discloses the privacy practices for DavidsList. This privacy policy applies solely to information collected by this web site. It will notify you of the following: <br>
		...
		<h3 class="centered-header">Information Collection, Use, and Sharing</h3>
		...
		<h3 class="centered-header">Your Access to and Control Over Information</h3>
		...
		<h3 class="centered-header">Security</h3>
		...
		<h3 class="centered-header">Updates</h3>
