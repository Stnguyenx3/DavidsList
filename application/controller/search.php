 ...
 * however, you can choose to omit appending the parameter to the url and choose
 * to send JSON to the controller if you choose to send JSON, you must use 
 * $_POST or $_GET, depending on your HTTP request, to access the elements in 
 * the JSON.
 *
...
class Search extends Controller {
    ...
    public function testPost() {
    	// echo htmlspecialchars($_POST); #This is for trying to read a string from 
        // the POST variable
